<nav x-data="{ open: false }" class="hover">
    <!-- Primary Navigation Menu -->
    <div class="hover bg-gray-800 w-full text-white">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center ml-3">
                    <a href="{{ route('dashboard') }}">
                        <img class="d-block" style="width: 40px;" src="{{ asset('img/icon-cut.png') }}" alt="Icone">
                    </a>
                </div>
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6 m-3">
